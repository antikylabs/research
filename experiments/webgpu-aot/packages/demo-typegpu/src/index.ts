...
import { startTypeGpuRenderer } from "./renderer.js";
...
const telemetry: WorkloadTelemetry = {
  implementation: "TypeGPU runtime",
  profile: profileName,
  status: "initializing",
  width: profile.width,
...
startTypeGpuRenderer(canvas, profileName, display, telemetry).catch((error: unknown) => {
